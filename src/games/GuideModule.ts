...
class GuideModule {
     ...
     * 构造函数
     */
    public constructor(ct:Main,iGuideNo,panel,panelNotice) {
		this.context = ct;
    ...
    private showNo1(){
        ...
        if(this.maskBg == null){
            ...
            this.maskBg.addEventListener(egret.TouchEvent.TOUCH_TAP,  function(e:egret.TouchEvent){ 
                this.showNo1();
            }, this);
        }
        ...
        let x = this.panel.getChildByName(this.getBtn()).x;
        let y = this.panel.getChildByName(this.getBtn()).y;
        let width = this.panel.getChildByName(this.getBtn()).width;
        let height = this.panel.getChildByName(this.getBtn()).height;
    ...
    private showNo2(){
        ...
        this.btn = new eui.Image(this.getBtnPng());
        let x = this.panel.getChildByName(this.getBtn()).x - 30;
        let y = this.panel.getChildByName(this.getBtn()).y + 100;
        if(ConstValue.deviveNormalScale > 2){
    ...
    private showNo4(){
        ...
        this.btn = new eui.Image(this.getBtnPng());
        let x = this.panel.getChildByName(this.getBtn()).x + 120;
        let y = this.panel.getChildByName(this.getBtn()).y + 480;
        if(ConstValue.deviveNormalScale > 2){
    ...
    private showNo5(){
        ...
        this.btn = new eui.Image(this.getBtnPng());
        let parent = this.panelNotice.getChildByName("fighting_parent");

        let x = parent.x + parent.getChildByName(this.getBtn()).x + 20;
        let y = parent.y + parent.getChildByName(this.getBtn()).y + 170;
        if(ConstValue.deviveNormalScale > 2){
    ...
    private showNo6(){
        ...
        let x = this.panel.getChildByName(this.getBtn()).x + 80;
        let y = this.panel.getChildByName(this.getBtn()).y + 350;
        if(ConstValue.deviveNormalScale > 2){
    ...
    private showNo7(){
        ...
        let x = this.panel.getChildByName(this.getBtn()).x ;
        let y = this.panel.getChildByName(this.getBtn()).y + 150;
        if(ConstValue.deviveNormalScale > 2){
            x = this.panel.getChildByName(this.getBtn()).x;
    ...
    private showNo8(){
        ...
        let x = this.panel.getChildByName(this.getBtn()).x + 80;
        let y = this.panel.getChildByName(this.getBtn()).y + 180;
        if(ConstValue.deviveNormalScale > 2){
            x = this.panel.getChildByName(this.getBtn()).x + 80;
