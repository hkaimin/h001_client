...
class ConstValue {
	...
	static P_IS_INNER:boolean = true;//false线上模式 true内网模式 有些提示只在内网提示
	...
	static p_is_PRINT_WALLET:boolean = true;
	static p_LOGIN_MODEL = 1;//普通的账号密码登陆 2微信登陆
	static p_USE_WALLET = 1;//是否使用钱包登陆
	static p_is_PRINT_WALLET_DEBUG:boolean = true;//是否打印debug
