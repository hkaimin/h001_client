window.skins=window.skins||{};
	...
	function LoginUI() {
		...
		this.height = 750;
		this.width = 1334;
		this.elementsContent = [this.account_lb_txt_i(),this.password_lb_txt_i(),this.account_lb_title_i(),this.password_lb_title_i(),this.btn_registe_i(),this.btn_login_i()];
	}
	var _proto = LoginUI.prototype;
