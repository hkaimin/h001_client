window.skins=window.skins||{};
	...
	var LoginUI$Skin26 = 	(function (_super) {
		...
		function LoginUI$Skin26() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","new_ui_09_02_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var LoginUI$Skin27 = 	(function (_super) {
		...
		function LoginUI$Skin27() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","new_ui_04_02_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var LoginUI$Skin28 = 	(function (_super) {
		...
		function LoginUI$Skin28() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","new_ui_06_02_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var LoginUI$Skin32 = 	(function (_super) {
		...
		function LoginUI$Skin32() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","new_ui_10_02_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	function LoginUI() {
		_super.call(this);
		this.skinParts = ["btn_info","info_grp","img_head_bg","img_info","img_exp_bg","img_exp_value","img_coin_bg","img_zuan_bg","btn_noticetip","btn_shop","hall_id_lb","coin_num_lb","zuan_num_lb","img_lv_lb","btn_map_diy","btn_friend","btn_setting","btn_ranking","btn_map_shop","btn_vip","btn_activity","btn_map_bag","btn_match_pvp","btn_training_pve","btn_noend_pve","btn_friend_pvp","btn_gm","btn_map_diy3","img_info0","img_info1","img_info2","rank_grounp_main"];
		
		this.height = 750;
		this.width = 1334;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.info_grp_i(),this.img_head_bg_i(),this.img_info_i(),this.img_exp_bg_i(),this.img_exp_value_i(),this.img_coin_bg_i(),this.img_zuan_bg_i(),this.btn_noticetip_i(),this.btn_shop_i(),this.hall_id_lb_i(),this.coin_num_lb_i(),this.zuan_num_lb_i(),this.img_lv_lb_i(),this.btn_map_diy_i(),this.btn_friend_i(),this.btn_setting_i(),this.btn_ranking_i(),this.btn_map_shop_i(),this.btn_vip_i(),this.btn_activity_i(),this.btn_map_bag_i(),this.btn_match_pvp_i(),this.btn_training_pve_i(),this.btn_noend_pve_i(),this.btn_friend_pvp_i(),this.btn_gm_i(),this.btn_map_diy3_i(),this.rank_grounp_main_i()];
	}
	var _proto = LoginUI.prototype;
	...
	_proto.btn_map_shop_i = function () {
		var t = new eui.Button();
		this.btn_map_shop = t;
		t.height = 90;
		t.label = "";
	...
	_proto.btn_activity_i = function () {
		var t = new eui.Button();
		this.btn_activity = t;
		t.height = 90;
		t.label = "";
	...
	__extends(NoticeGroup, _super);
	var NoticeGroup$Skin44 = 	(function (_super) {
		__extends(NoticeGroup$Skin44, _super);
		function NoticeGroup$Skin44() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = NoticeGroup$Skin44.prototype;
		...
		return NoticeGroup$Skin44;
	})(eui.Skin);

	var NoticeGroup$Skin45 = 	(function (_super) {
		__extends(NoticeGroup$Skin45, _super);
		function NoticeGroup$Skin45() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = NoticeGroup$Skin45.prototype;
		...
		return NoticeGroup$Skin45;
	})(eui.Skin);

	var NoticeGroup$Skin46 = 	(function (_super) {
		__extends(NoticeGroup$Skin46, _super);
		function NoticeGroup$Skin46() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = NoticeGroup$Skin46.prototype;
	...
	_proto.fighting_parent_i = function () {
		...
		t.x = 125.4;
		t.y = 6;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this.fighting_platform_i(),this._Image4_i(),this.match_rank_bg_i(),this.lv_rank_bg_i(),this.match_rank_lb_i(),this.lv_rank_lb_i(),this.scroll_i(),this.myrankG_i(),this.all_rank_bg_i(),this.friend_rank_bg_i(),this.friend_rank_lb_i(),this.all_rank_lb_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.x = 2.7;
		t.y = 2.66;
		t.elementsContent = [this._Image5_i(),this._Label1_i(),this._Label2_i(),this._Label3_i(),this._Image6_i(),this._Image7_i()];
		return t;
	};
	_proto._Image5_i = function () {
		var t = new eui.Image();
	...
	_proto._Group2_i = function () {
		...
		t.x = 0.54;
		t.y = 71.74;
		t.elementsContent = [this._Image8_i(),this._Label4_i(),this._Label5_i(),this._Label6_i(),this._Image9_i(),this._Image10_i()];
		return t;
	};
	_proto._Image8_i = function () {
		var t = new eui.Image();
	...
	_proto._Group3_i = function () {
		...
		t.x = 0.07;
		t.y = 139.45;
		t.elementsContent = [this._Image11_i(),this._Label7_i(),this._Label8_i(),this._Label9_i(),this._Image12_i(),this._Image13_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.x = 1.24;
		t.y = 208.11;
		t.elementsContent = [this._Image14_i(),this._Label10_i(),this._Label11_i(),this._Label12_i(),this._Image15_i(),this._Image16_i()];
		return t;
	};
	...
	_proto._Group5_i = function () {
		...
		t.x = 1.24;
		t.y = 275.81;
		t.elementsContent = [this._Image17_i(),this._Label13_i(),this._Label14_i(),this._Label15_i(),this._Image18_i(),this._Image19_i()];
		return t;
	};
	...
	_proto._Group6_i = function () {
		...
		t.x = 0.9;
		t.y = 343.52;
		t.elementsContent = [this._Image20_i(),this._Label16_i(),this._Label17_i(),this._Label18_i(),this._Image21_i(),this._Image22_i()];
		return t;
	};
	...
	_proto._Group7_i = function () {
		...
		t.x = 1.55;
		t.y = 409.71;
		t.elementsContent = [this._Image23_i(),this._Label19_i(),this._Label20_i(),this._Label21_i(),this._Image24_i(),this._Image25_i()];
		return t;
	};
	...
	_proto._Group8_i = function () {
		...
		t.x = 0.91;
		t.y = 478.8;
		t.elementsContent = [this._Image26_i(),this._Label22_i(),this._Label23_i(),this._Label24_i(),this._Image27_i(),this._Image28_i()];
		return t;
	};
	...
	_proto.myrankG_i = function () {
		...
		t.x = 218.49;
		t.y = 591.84;
		t.elementsContent = [this._Image29_i(),this.myrank_i(),this.name_i(),this.desc_i(),this._Image30_i(),this.head_i()];
		return t;
	};
	...
	function LoginUI() {
		_super.call(this);
		this.skinParts = ["btn_close","img_buy_bg","lb_name","btn_gold","lb_gold","lb_attr","btn_shop","btn_shop0","btn_shop1","btn_shop2","lb_life","lb_boom","lb_speed","lb_power","scroll_group0","scroll0","fighting_parent","btn_buy","btn_fight","lb_role_click"];
		
		this.height = 750;
		this.width = 1334;
		this.elementsContent = [this._Image1_i(),this.btn_close_i(),this._Image2_i(),this.img_buy_bg_i(),this.lb_name_i(),this.btn_gold_i(),this.lb_gold_i(),this._Image3_i(),this._Label1_i(),this._Label2_i(),this.lb_attr_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this._Image7_i(),this.btn_shop_i(),this.btn_shop0_i(),this.btn_shop1_i(),this.btn_shop2_i(),this._Label3_i(),this.lb_life_i(),this.lb_boom_i(),this.lb_speed_i(),this._Label4_i(),this._Label5_i(),this._Label6_i(),this.lb_power_i(),this.fighting_parent_i(),this.btn_buy_i(),this.btn_fight_i(),this.lb_role_click_i()];
	}
	var _proto = LoginUI.prototype;
