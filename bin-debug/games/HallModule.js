...
var HallModule = (function () {
    ...
    HallModule.prototype.changeHorseRight = function (index) {
        ...
        var horseObj = this.getOwnHorseInfoById(selectIdx);
        if (horseObj == null)
            return;
        var leftX2 = 900;
        var downY2 = 100;
        ...
        if (this.curPage == 2 || this.curPage == 5) {
            ...
            if (index == 1) {
                ...
                var energy_length = this.horseSelectRightPanel.getChildByName("energy_length");
                ...
                var dexterity_w = energy_length.width * (horseObj.dexterity * 1.0 / horseObj.MaxDexterity);
                ...
                var burse_w = energy_length.width * (horseObj.burse * 1.0 / horseObj.MaxBurse);
                ...
                var grassLand_length = this.horseSelectRightPanel.getChildByName("grassLand_length");
                var iPerGrass = horseObj.grassland * 1.0 / horseObj.landMax;
                var grassLand_w = grassLand_length.width * iPerGrass;
                ...
                var iPerSand = horseObj.sand * 1.0 / horseObj.landMax;
                var sand_w = grassLand_length.width * iPerSand;
                ...
                var iPerMud = horseObj.mud * 1.0 / horseObj.landMax;
                var mud_w = grassLand_length.width * iPerMud;
            ...
            for (var starNum = 1; starNum <= 5; starNum++) {
                if (starNum > horseObj.star)
                    this.horseSelectRightPanel.getChildByName("star_" + starNum).source = "icon_stars_0_png";
            }
    ...
    HallModule.prototype.getOwnHorseInfoById = function (id) {
        var hData = this.horseOwnData;
    ...
    HallModule.prototype.getPOwnHorseInfoById = function (id) {
        var hData = this.horseOwnData;
        for (var index in hData) {
            var obj = hData[index];
            if (obj.id == id)
    ...
    HallModule.prototype.updateHorseItemMiddle = function (obj) {
        ...
        if (this.curPage == 4 && this.subCurPage == 2) {
            var sData = CommonTools.getDataJsonStr("getCargoInfo", 1, { iType: this.mergeType, iStar: obj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }
        if (this.curPage == 4 && this.subCurPage == 3) {
            var sData = CommonTools.getDataJsonStr("getPeddInfo", 1, { iStar: obj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }
        if (this.curPage == 3) {
    ...
    HallModule.prototype.createHorseItem = function () {
        ...
        var i = 0;
        var _loop_1 = function (hIndex) {
            var obj = this_1.horseOwnData[hIndex];
            if (this_1.horseItemS == 0)
                this_1.horseItemS = obj.id;
            ...
            var tGroup = panelT.getChildByName("group_1");
            tGroup.getChildByName("horse_lv_img").source = "icon_level_" + obj.iType + "_png";
            tGroup.getChildByName("horse_head").source = "horse" + obj.res_key + "_head01_png";
            for (var star = 1; star <= 5; star++) {
                if (star > obj.star)
                    tGroup.getChildByName("start_" + star).source = "icon_stars_0_png";
            }
            panelT.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
                CommonAudioHandle.playEffect("playBomb_mp3", 1);
                for (var thIndex in this.horseOwnData) {
                    var tobj = this.horseOwnData[thIndex];
                    var tempPanel = groupShop.getChildByName("p_" + tobj.id);
        ...
        // let showCnt = 0;
        // if(count >= 5)showCnt = 2;
        var groupItem = groupShop.getChildByName("p_" + this.horseItemS);
    ...
    HallModule.prototype.CreateMarketItems = function (opType) {
        ...
        var _loop_2 = function (index) {
            ...
            var horse_sex = group_1.getChildByName("horse_sex");
            horse_sex.source = obj.iSex == 1 ? "icon_Male_png" : "icon_female_png";
            for (var starNum = 1; starNum <= 5; starNum++) {
                if (starNum > obj.star) {
                    var horse_star = group_1.getChildByName("start_" + starNum);
            ...
            if (this_2.horseIndexS == 0) {
                ...
                this_2.panel.getChildByName("buynft_group").getChildByName("buy_nft_main").text = obj.money;
                this_2.changeHorseRight(1);
            }
            panelT.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
                CommonAudioHandle.playEffect("playBomb_mp3", 1);
    ...
    HallModule.prototype.createCargoSuccess = function (index, dData, isPedd) {
        if (index == 1) {
            CommonAudioHandle.playEffect("success_mp3", 1);
        }
        else {
    ...
    HallModule.prototype.task01UI = function () {
        ...
        this.horseSelectMiddlePanel.getChildByName("clain_rewards_btn").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            if (parseInt(this.horseSelectMiddlePanel.getChildByName("my_reward_tip").text) <= 0)
                return;
            this.addCommonTips(ConstValue.P_PUSHING_TR);
            var sData = CommonTools.getDataJsonStr("claimExhi", 1, { lNft: ConstValue.cacheContract["nftIndex"] });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        this.tipsPanel = this.horseSelectMiddlePanel;
        var L_select_group = this.horseSelectMiddlePanel.getChildByName("L_select_group");
        var scroll = L_select_group.getChildByName("L_scoller");
        var group = scroll.getChildByName("L_s_group");
        group.removeChildren();
        var i = 1;
        var tL_score = 0;
        var tL_horse = 0;
        var L_select_cnt = L_select_group.getChildByName("L_select_cnt");
        var L_select_score = L_select_group.getChildByName("L_select_score");
        var _loop_4 = function (index) {
            ...
            group.addChild(panelT);
            var group_1 = panelT.getChildByName("group_1");
            group_1.getChildByName("horse_body").source = "horse" + obj.res_key + "_body_png";
            group_1.getChildByName("horse_lv_img").source = "icon_level_" + obj.iType + "_png";
            group_1.getChildByName("name").text = obj.name;
            group_1.getChildByName("score").text = obj.score;
            for (var star = 1; star <= 5; star++) {
                if (star > obj.star)
                    group_1.getChildByName("start_" + star).source = "icon_stars_0_png";
            }
            panelT.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
                CommonAudioHandle.playEffect("playBomb_mp3", 1);
                if (obj.sellStatus == 1) {
                ...
                var tCheck = group_1.getChildByName("L_select_checked").visible;
                ...
                for (var index2 in this.horseOwnData) {
                    var tobj = this.horseOwnData[index2];
                    if (group.getChildByName("p_" + tobj.id).getChildByName("group_1").getChildByName("L_select_checked").visible) {
                        tScore += tobj.score;
                        tHorse += 1;
                    }
                }
        ...
        L_select_group.getChildByName("L_join_btn").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            var sArr = new Array();
            for (var index in this.horseOwnData) {
                var obj = this.horseOwnData[index];
                if (group.getChildByName("p_" + obj.id).getChildByName("group_1").getChildByName("L_select_checked").visible)
                    sArr.push(obj.id);
            }
            var sData = CommonTools.getDataJsonStr("joinExhi", 1, { lSelectNft: sArr, lNft: ConstValue.cacheContract["nftIndex"] });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        var lChecked = L_select_group.getChildByName("L_select_checked");
        lChecked.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            ...
            for (var index in this.horseOwnData) {
                var obj = this.horseOwnData[index];
                group.getChildByName("p_" + obj.id).getChildByName("group_1").getChildByName("L_select_checked").visible = false;
            }
        }, this);
        var lCheckedBG = L_select_group.getChildByName("lCheckedBG");
        lCheckedBG.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            ...
            for (var index in this.horseOwnData) {
                var obj = this.horseOwnData[index];
                if (obj.sellStatus != 1)
                    group.getChildByName("p_" + obj.id).getChildByName("group_1").getChildByName("L_select_checked").visible = true;
            }
        }, this);
        var M_select_group = this.horseSelectMiddlePanel.getChildByName("M_select_groupp");
        var M_scoller = M_select_group.getChildByName("M_scrolle");
        var M_s_group = M_scoller.getChildByName("M_s_group");
        M_s_group.removeChildren();
        var ii = 1;
        var tM_score = 0;
        var tM_horse = 0;
        var M_select_cnt = M_select_group.getChildByName("M_select_cnt");
        var M_select_score = M_select_group.getChildByName("M_select_score");
        var _loop_5 = function (index) {
            var obj = this_5.horseOwnData[index];
            if (obj.exhibition != null && obj.exhibition == 1) {
                tM_score += obj.score;
                tM_horse += 1;
            }
            ...
            panelT.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
                ...
                var tHorse = 0;
                for (var index1 in this.horseOwnData) {
                    var tobj = this.horseOwnData[index1];
                    var p2Obj = M_s_group.getChildByName("p2_" + tobj.id);
                    if (p2Obj)
                        tHorseMax += 1;
                }
                for (var index2 in this.horseOwnData) {
                    ...
                    var p2Obj = M_s_group.getChildByName("p2_" + tobj.id);
                    if (p2Obj) {
                        if (M_s_group.getChildByName("p2_" + tobj.id).getChildByName("group_1").getChildByName("L_select_checked").visible) {
                            tScore += tobj.score;
                            tHorse += 1;
                        }
                    }
        ...
        M_select_group.getChildByName("M_rest_btn").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            var sArr = new Array();
            for (var index in this.horseOwnData) {
                var obj = this.horseOwnData[index];
                var p2Obj = M_s_group.getChildByName("p2_" + obj.id);
                if (p2Obj) {
                    if (M_s_group.getChildByName("p2_" + obj.id).getChildByName("group_1").getChildByName("L_select_checked").visible)
                        sArr.push(obj.id);
                }
            }
            var sData = CommonTools.getDataJsonStr("gorestExhi", 1, { lSelectNft: sArr, lNft: ConstValue.cacheContract["nftIndex"] });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        var MChecked = M_select_group.getChildByName("M_select_checked");
        MChecked.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            ...
            for (var index in this.horseOwnData) {
                ...
                var p2Obj = M_s_group.getChildByName("p2_" + obj.id);
                if (p2Obj)
                    M_s_group.getChildByName("p2_" + obj.id).getChildByName("group_1").getChildByName("L_select_checked").visible = false;
            }
        }, this);
        var MCheckedBG = M_select_group.getChildByName("mCheckedBG");
        MCheckedBG.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            ...
            for (var index in this.horseOwnData) {
                ...
                var p2Obj = M_s_group.getChildByName("p2_" + obj.id);
                if (p2Obj)
                    M_s_group.getChildByName("p2_" + obj.id).getChildByName("group_1").getChildByName("L_select_checked").visible = true;
            }
        }, this);
    };
    HallModule.prototype.updateTask02 = function (dData) {
    ...
    HallModule.prototype.task02UI = function () {
        ...
        this.horseSelectRightPanel.getChildByName("s_1").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            ...
            this.mergeType = 1;
            var tobj = this.getPOwnHorseInfoById(this.horseItemS);
            var sData = CommonTools.getDataJsonStr("getCargoInfo", 1, { iType: 1, iStar: tobj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        this.horseSelectRightPanel.getChildByName("s_2").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            ...
            this.mergeType = 2;
            var tobj = this.getPOwnHorseInfoById(this.horseItemS);
            var sData = CommonTools.getDataJsonStr("getCargoInfo", 1, { iType: 2, iStar: tobj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        this.horseSelectRightPanel.getChildByName("s_3").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            ...
            this.mergeType = 3;
            var tobj = this.getPOwnHorseInfoById(this.horseItemS);
            var sData = CommonTools.getDataJsonStr("getCargoInfo", 1, { iType: 3, iStar: tobj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        this.horseSelectRightPanel.getChildByName("s_4").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            ...
            this.mergeType = 4;
            var tobj = this.getPOwnHorseInfoById(this.horseItemS);
            var sData = CommonTools.getDataJsonStr("getCargoInfo", 1, { iType: 4, iStar: tobj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        this.horseSelectRightPanel.getChildByName("Process_btn_lb").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            ...
            var tobj = this.getPOwnHorseInfoById(this.horseItemS);
            var sData = CommonTools.getDataJsonStr("doCargoNft", 1, { iType: this.mergeType, nftIndex: tobj.id, iScore: tobj.score, iStar: tobj.star });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
        this.mergeType = 1;
        var sData = CommonTools.getDataJsonStr("getCargoInfo", 1, { iType: 1, iStar: obj.star });
        ConstValue.P_NET_OBJ.sendData(sData);
    };
    HallModule.prototype.updateTask03 = function (dData) {
    ...
    HallModule.prototype.sendDoPedd = function () {
        var tobj = this.getPOwnHorseInfoById(this.horseItemS);
        var sData = CommonTools.getDataJsonStr("doPeddNft", 1, { iType: this.mergeType, nftIndex: tobj.id, iScore: tobj.score, iStar: tobj.star });
        ConstValue.P_NET_OBJ.sendData(sData);
    };
    HallModule.prototype.task03UI = function () {
        ...
        this.horseSelectRightPanel.getChildByName("bg_1").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
        ...
        this.horseSelectRightPanel.getChildByName("bg_2").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
        ...
        this.horseSelectRightPanel.getChildByName("bg_3").addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            CommonAudioHandle.playEffect("playBomb_mp3", 1);
            this.horseSelectRightPanel.getChildByName("check_1").visible = false;
            this.horseSelectRightPanel.getChildByName("check_2").visible = false;
    ...
    HallModule.prototype.timeGetTotalExhi = function () {
        FightingModule.Delay(60000, function () {
            var sData = CommonTools.getDataJsonStr("getTotalExhi", 1, { lNft: ConstValue.cacheContract["nftIndex"] });
            ConstValue.P_NET_OBJ.sendData(sData);
        }, this);
    };
    ...
    HallModule.prototype.testAddMain = function () {
        CommonTools.addCommonTips(this.tipsPanel, ConstValue.P_PUSHING_TR);
        var sData = CommonTools.getDataJsonStr("AddMainCoin", 1, { iAdd: 50000, iOpType: 0 });
        ConstValue.P_NET_OBJ.sendData(sData);
    };
    HallModule.prototype.testAddSub = function () {
        CommonTools.addCommonTips(this.tipsPanel, ConstValue.P_PUSHING_TR);
        var sData = CommonTools.getDataJsonStr("AddSubCoin", 1, { iAdd: 50000, iOpType: 0 });
        ConstValue.P_NET_OBJ.sendData(sData);
    };
    ...
    HallModule.prototype.pBuyNft = function () {
        var sDataBuybtn = CommonTools.getDataJsonStr("PBuyNft", 1, { nftIndex: this.horseIndexS, sAddress: ContractSol.sender });
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case "up_img": return [3 /*break*/, 4];
                            case "down_img": return [3 /*break*/, 5];
                            case "buynft_btn_lb": return [3 /*break*/, 6];
                            case "btn_back_img": return [3 /*break*/, 7];
                            case "noend_tip": return [3 /*break*/, 8];
                            case "btn_tip": return [3 /*break*/, 9];
                            case "friend_rank_lb": return [3 /*break*/, 10];
                            case "btn_2v2": return [3 /*break*/, 11];
                            case "btn_close": return [3 /*break*/, 12];
                            case "btn_close_wx_vs": return [3 /*break*/, 13];
                            case "btn_start": return [3 /*break*/, 14];
                            case "btn_shop": return [3 /*break*/, 15];
                            case "btn_training_pve": return [3 /*break*/, 16];
                            case "btn_ranking": return [3 /*break*/, 17];
                            case "btn_gonggao": return [3 /*break*/, 18];
                            case "all_rank_lb": return [3 /*break*/, 19];
                            case "barrier_rank_lb": return [3 /*break*/, 19];
                            case "match_rank_lb": return [3 /*break*/, 20];
    ...
    HallModule.prototype.handleSkill = function (group, parG) {
        ...
        var _loop_6 = function (i) {
            ...
            if (obj.isOpen == 1) {
                ...
                CommonButtonHandle.beginTouch(skill_learn, this_6);
                if (obj.curLv > 0) {
                    skill_learn.text = "升级";
    ...
    HallModule.prototype.handleRoleClass = function (group, parG) {
        var _loop_7 = function (i) {
            var classObj = this_7.roleClassData[i];
            var ii = parseInt(i);
            var panelT = new eui.Panel();
    ...
    HallModule.prototype.handleGetMyMaps = function () {
        ...
        var _loop_8 = function (key) {
            var obj = this_8.selectMapData[key];
            var panelT = new eui.Panel();
    ...
    HallModule.prototype.handleNoEnd = function (group, parG) {
        ...
        var _loop_9 = function (idx) {
            var obj = this_9.barrData.barrierList[idx];
            var panelT = new eui.Panel();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 51];
                    case 6:
                        if (!(jsonObj.f == "SellNft")) return [3 /*break*/, 7];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            ContractSol.nft_tokensOfOwner(ContractSol.sender);
                        ...
                        return [3 /*break*/, 51];
                    case 7:
                        if (!(jsonObj.f == "getOwnNft")) return [3 /*break*/, 8];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 8:
                        if (!(jsonObj.f == "getTotalExhi")) return [3 /*break*/, 9];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 9:
                        if (!(jsonObj.f == "joinExhi" || jsonObj.f == "gorestExhi")) return [3 /*break*/, 10];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (this.curPage == 4 && this.subCurPage == 1) {
                        ...
                        return [3 /*break*/, 51];
                    case 10:
                        if (!(jsonObj.f == "AddMainCoin" || jsonObj.f == "claimExhi")) return [3 /*break*/, 11];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 11:
                        if (!(jsonObj.f == "getMergeInfo")) return [3 /*break*/, 12];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (this.curPage == 2 && this.subCurPage == 2) {
                        ...
                        return [3 /*break*/, 51];
                    case 12:
                        if (!(jsonObj.f == "getBreedInfo")) return [3 /*break*/, 13];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (this.curPage == 2 && this.subCurPage == 3) {
                        ...
                        return [3 /*break*/, 51];
                    case 13:
                        if (!(jsonObj.f == "doMergeNft")) return [3 /*break*/, 14];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 14:
                        if (!(jsonObj.f == "getTrainInfo")) return [3 /*break*/, 15];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 15:
                        if (!(jsonObj.f == "getCargoInfo")) return [3 /*break*/, 16];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 16:
                        if (!(jsonObj.f == "getPeddInfo")) return [3 /*break*/, 17];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 17:
                        if (!(jsonObj.f == "doCargoNft")) return [3 /*break*/, 18];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (jsonObj.d.result == 1) {
                        ...
                        return [3 /*break*/, 51];
                    case 18:
                        if (!(jsonObj.f == "doPeddNft")) return [3 /*break*/, 19];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (jsonObj.d.result == 1) {
                        ...
                        return [3 /*break*/, 51];
                    case 19:
                        if (!(jsonObj.f == "doTrainNft")) return [3 /*break*/, 20];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 20:
                        if (!(jsonObj.f == "doBreedNft")) return [3 /*break*/, 21];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (jsonObj.d.result == 2)
                        ...
                        return [3 /*break*/, 51];
                    case 21:
                        if (!(jsonObj.f == "AddSubCoin")) return [3 /*break*/, 22];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 22:
                        if (!(jsonObj.f == "getPvpRankThree")) return [3 /*break*/, 23];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        }
                        return [3 /*break*/, 51];
                    case 23:
                        if (!(jsonObj.f == "getHelp" || jsonObj.f == "getGonggao")) return [3 /*break*/, 24];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (ConstValue.p_USE_WALLET == 1)
                        ...
                        return [3 /*break*/, 51];
                    case 24:
                        if (!(jsonObj.f == "Room1v1Dismiss")) return [3 /*break*/, 25];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 25:
                        if (!(jsonObj.f == "WaitingInfo")) return [3 /*break*/, 26];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        ...
                        return [3 /*break*/, 51];
                    case 26:
                        if (!(jsonObj.f == "syncMapData")) return [3 /*break*/, 31];
                        if (!(jsonObj.m != "" || jsonObj.s != 1)) return [3 /*break*/, 27];
                        return [3 /*break*/, 30];
                    case 27:
                        if (!(ConstValue.cacheKeyGroup["fighting"] == null)) return [3 /*break*/, 29];
                    ...
                    case 29:
                        ...
                        _a.label = 30;
                    case 30: return [3 /*break*/, 51];
                    case 31:
                        if (!(jsonObj.f == "openDiyMapUI")) return [3 /*break*/, 32];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (ConstValue.P_MAP_OBJ == null) {
                        ...
                        return [3 /*break*/, 51];
                    case 32:
                        if (!(jsonObj.f == "showAllClassList" || jsonObj.f == "reflashClassList")) return [3 /*break*/, 33];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 33:
                        if (!(jsonObj.f == "openShopUI")) return [3 /*break*/, 34];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 34:
                        if (!(jsonObj.f == "openBagUI")) return [3 /*break*/, 35];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 35:
                        if (!(jsonObj.f == "Buy")) return [3 /*break*/, 36];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (jsonObj.d.err == 0) {
                        ...
                        return [3 /*break*/, 51];
                    case 36:
                        if (!(jsonObj.f == "getMyMaps")) return [3 /*break*/, 37];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            FightingModule.Delay(500, function () {
                        ...
                        return [3 /*break*/, 51];
                    case 37:
                        if (!(jsonObj.f == "C2GOpenWujinUI")) return [3 /*break*/, 38];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 38:
                        if (!(jsonObj.f == "SeventDayReward")) return [3 /*break*/, 39];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                            if (ConstValue.p_USE_WALLET == 1)
                        ...
                        return [3 /*break*/, 51];
                    case 39:
                        if (!(jsonObj.f == "G2C_getWXInfo")) return [3 /*break*/, 43];
                        if (!(jsonObj.m != "" || jsonObj.s != 1)) return [3 /*break*/, 40];
                        return [3 /*break*/, 42];
                    case 40:
                    ...
                    case 43:
                        if (!(jsonObj.f == "saveWXInfo")) return [3 /*break*/, 44];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 44:
                        if (!(jsonObj.f == "showUpgradeReward")) return [3 /*break*/, 45];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 45:
                        if (!(jsonObj.f == "GuildInfo")) return [3 /*break*/, 46];
                        if (jsonObj.m != "" || jsonObj.s != 1) {
                        }
                        else {
                        ...
                        return [3 /*break*/, 51];
                    case 46:
                        if (!(jsonObj.f == "open1V1Room" || jsonObj.f == "open1V1RoomByMap")) return [3 /*break*/, 50];
                        if (!(jsonObj.m != "" || jsonObj.s != 1)) return [3 /*break*/, 47];
                        return [3 /*break*/, 49];
                    case 47:
                        CommonTools.log("shareAppMessage-------1");
