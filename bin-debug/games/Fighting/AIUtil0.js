...
//AI组件
var AIUtil0 = (function () {
    function AIUtil0(playerObj, testMap, initRow, initColumn, appMode) {
    ...
    AIUtil0.prototype.beNotifyHasFood = function (x, y) {
    ...
    AIUtil0.prototype.moveNext = function () {
        if (!this.iOpenState)
            return;
    ...
    AIUtil0.prototype.resetMove = function (tPath) {
        this.curPathPointIndex = 0;
        this.curPath = tPath;
    };
    AIUtil0.prototype.openBlock = function (x, y) {
    ...
    AIUtil0.prototype.getNextBox = function () {
    ...
    AIUtil0.prototype.isHasBoom = function () {
        if (this.isConnectEnemy()) {
    ...
    AIUtil0.prototype.getSafePath = function () {
    ...
    AIUtil0.prototype.getPath = function (xEnd, yEnd) {
    ...
    AIUtil0.prototype.startAI = function () {
    };
    AIUtil0.prototype.stopAI = function () {
        this.iOpenState = false;
    };
    //目前是1v1
    AIUtil0.prototype.isConnectEnemy = function () {
        var pathForEnemy = this.getPath(this.getOtherPlayer().getColumn(), this.getOtherPlayer().getRow());
        if (pathForEnemy.length == 0)
            return false;
        return true;
    };
    AIUtil0.prototype.setWalkAble = function (x, y, canWork) {
        this.grid.setWalkableAt(x, y, canWork);
    };
    AIUtil0.prototype.getOtherPlayer = function () {
    ...
    AIUtil0.prototype.move = function (endX, endY) {
    ...
    AIUtil0.prototype.clear = function () {
        this.aiObj = null;
        this.grid = null;
        this.op = null;
        this.finder = null;
...
__reflect(AIUtil0.prototype, "AIUtil0");
//# sourceMappingURL=AIUtil0.js.map