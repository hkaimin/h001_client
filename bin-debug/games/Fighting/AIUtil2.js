...
//AI组件
var AIUtil2 = (function () {
    function AIUtil2(playerObj, testMap, initRow, initColumn, appMode) {
    ...
    AIUtil2.prototype.beNotifyHasFood = function (x, y) {
    ...
    AIUtil2.prototype.moveNext = function () {
        if (!this.iOpenState)
            return;
    ...
    AIUtil2.prototype.resetMove = function (tPath) {
        this.curPathPointIndex = 0;
        this.curPath = tPath;
    };
    AIUtil2.prototype.openBlock = function (x, y) {
    ...
    AIUtil2.prototype.getNextBox = function () {
    ...
    AIUtil2.prototype.isHasBoom = function () {
        if (this.isConnectEnemy()) {
    ...
    AIUtil2.prototype.getSafePath = function () {
    ...
    AIUtil2.prototype.getPath = function (xEnd, yEnd) {
    ...
    AIUtil2.prototype.startAI = function () {
    ...
    AIUtil2.prototype.stopAI = function () {
        this.iOpenState = false;
    };
    //目前是1v1
    AIUtil2.prototype.isConnectEnemy = function () {
        var pathForEnemy = this.getPath(this.getOtherPlayer().getColumn(), this.getOtherPlayer().getRow());
        if (pathForEnemy.length == 0)
            return false;
        return true;
    };
    AIUtil2.prototype.setWalkAble = function (x, y, canWork) {
        this.grid.setWalkableAt(x, y, canWork);
    };
    AIUtil2.prototype.getOtherPlayer = function () {
    ...
    AIUtil2.prototype.move = function (endX, endY) {
    ...
    AIUtil2.prototype.clear = function () {
        this.aiObj = null;
        this.grid = null;
        this.op = null;
        this.finder = null;
...
__reflect(AIUtil2.prototype, "AIUtil2");
//# sourceMappingURL=AIUtil2.js.map