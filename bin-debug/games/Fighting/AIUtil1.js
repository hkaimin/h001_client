...
//AI组件
var AIUtil1 = (function () {
    function AIUtil1(playerObj, testMap, initRow, initColumn, appMode) {
    ...
    AIUtil1.prototype.beNotifyHasFood = function (x, y) {
    ...
    AIUtil1.prototype.moveNext = function () {
        if (!this.iOpenState)
            return;
        if (this.isConnectEnemy()) {
            this.isTrueConnectEnemy = true;
        ...
        if (this.curPathPointIndex >= iMax) {
            ...
            if (this.isVirtualOpen) {
                ...
                if (this.iCmd == 1) {
                    ...
                    if (this.isConnectEnemy()) {
                        CommonTools.logAI("move------7777777777777777777777777777777777a");
                        this.removeDelay();
                        this.delayFunc = function () {
                            CommonTools.logAI("move------77777777777777777777777777777777771");
                            if (this.iCmd == 1) {
                                CommonTools.log("move------77777777777777777777777777777777772");
                                this.moveNext(); //执行下个命令
                            }
                        };
                        this.Delay(10);
                        ...
                        CommonTools.logAI("move------7777777777777777777777777777777777b");
                        this.removeDelay();
                        this.delayFunc = function () {
                            CommonTools.logAI("move------77777777777777777777777777777777773");
                            if (this.iCmd == 1) {
                                this.moveNext(); //执行下个命令
                            }
                        };
                        if (this.isTrueConnectEnemy) {
                            this.Delay(1000);
                        }
                        else {
                            this.Delay(3800);
    ...
    AIUtil1.prototype.resetMove = function (tPath) {
        this.curPathPointIndex = 0;
        this.curPath = tPath;
    };
    AIUtil1.prototype.openBlock = function (x, y) {
    ...
    AIUtil1.prototype.getNextBox = function () {
    ...
    AIUtil1.prototype.isHasBoom = function () {
        if (this.isConnectEnemy()) {
            for (var bul in FightingModule.bulletLayerSubObj) {
                var bulobj = FightingModule.bulletLayerSubObj[bul];
                if (Math.abs(this.aiObj.getColumn() - bulobj.getColumn()) <= 2 && Math.abs(this.aiObj.getRow() - bulobj.getRow()) <= 2) {
                    return true;
                }
            }
        }
    ...
    AIUtil1.prototype.getSafePath = function () {
    ...
    AIUtil1.prototype.getPath = function (xEnd, yEnd) {
    ...
    AIUtil1.prototype.startAI = function () {
    ...
    AIUtil1.prototype.stopAI = function () {
        this.iOpenState = false;
    };
    //目前是1v1
    AIUtil1.prototype.isConnectEnemy = function () {
        var pathForEnemy = this.getPath(this.getOtherPlayer().getColumn(), this.getOtherPlayer().getRow());
        if (pathForEnemy.length == 0)
            return false;
        return true;
    };
    AIUtil1.prototype.setWalkAble = function (x, y, canWork) {
        this.grid.setWalkableAt(x, y, canWork);
    };
    AIUtil1.prototype.getOtherPlayer = function () {
    ...
    AIUtil1.prototype.move = function (endX, endY) {
    ...
    AIUtil1.prototype.clear = function () {
        this.aiObj = null;
        this.grid = null;
        this.op = null;
        this.finder = null;
...
__reflect(AIUtil1.prototype, "AIUtil1");
//# sourceMappingURL=AIUtil1.js.map